...
void Filter_Plugin::processImage(const cv::Mat &inputImage, cv::Mat &outputImage)
{
    ...
    switch (ui->mainTabs->currentIndex()) {
        ...
        case BILATERAL_FILTER_PAGE:
                   bilateralFilter(inputImage, outputImage,
    ...
    case BLUR_FILTER_PAGE:
     ...
     case BOX_FILTER_PAGE:
                      boxFilter(inputImage, outputImage,
    ...
    case MEDIAN_FILTER_PAGE:
                medianBlur(inputImage, outputImage, ui->medianApertureSpin->value());
                break;
    ...
    case FILTER2D_PAGE:
                ...
                filter2D(inputImage, outputImage,
                                 -1,
                                f2dkernel,
                                Point(-1, -1));
                break;
    ...
    case DERIVATIVES_PAGE:
                if(ui->derivSobelRadio->isChecked())
                        ...
                        Laplacian(inputImage, outputImage, -1, 3, ui->derivScaleSpin->value(), ui->derivScaleSpin->value());
                break;
    ...
    case MORPH_PAGE:
                ...
                else if(ui->morphErodeRadio->isChecked())
                {
